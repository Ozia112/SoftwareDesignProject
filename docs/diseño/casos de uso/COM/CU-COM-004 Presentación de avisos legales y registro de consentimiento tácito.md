...
- RN-COM-07-01: No se debe de guardar información de contacto antes de que la Persona interesada haya interactuado en el canal.
- RN-COM-07-02: El consentimiento debe quedar registrado para auditoría.
- RN-COM-07-03: Los avisos y términos deben mostrarse antes de capturar cualquier dato personal.
...
[nombre de aviso]:<CU-COM-004 Presentación de avisos legales y registro de consentimiento tácito.md> "Nombre del aviso legal obtenido del banco de contexto"
