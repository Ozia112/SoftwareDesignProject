...
| --- | --- | --- | --- |
| 🆕 | [CU-COM-001](<../../diseño/casos de uso/COM/CU-COM-001 Asignación de conversaciones de un bot a un operador humano.md>) | Caso de uso | Ajusta el nombre del actor y deja el flujo bot-operador alineado con la redaccion actual. |
