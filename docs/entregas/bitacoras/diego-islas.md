...
- El sistema carecía de representación visual del flujo de interacción entre componentes:  
  ...
  **Decisiones:**
  ...
  - [X] [`diagrama-secuencia.md`](</docs/diseño/modelos de diseño/diagrama-secuencia.md>) — Se crea el documento de referencia que describe los tres procesos modelados e incluye el enlace de acceso a los diagramas. — **Creado:** 30 / 04 / 2026
